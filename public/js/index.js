...
async function loadArticles() {
    ...
    // Trier les articles par date de la plus récente à la plus ancienne
...
(async () => {
    try {
        // Récupérer les images du serveur Express
        const response = await fetch('/images');
        const images = await response.json();

        const carouselInner = document.querySelector('.carousel-inner');

        // Parcourir la liste des images et créer les éléments correspondants
